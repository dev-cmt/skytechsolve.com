...
<head>
    ...
    @stack('css')
    <style>
        /* Dark Mode support for SweetAlert Toasts & Toastr */
        html[data-theme-mode="dark"] .swal2-popup.swal2-toast {
            background-color: #1a1e25 !important;
            color: #a3aed1 !important;
            box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.5) !important;
            border: 1px solid rgba(255, 255, 255, 0.05);
        }
        html[data-theme-mode="dark"] .swal2-popup.swal2-toast .swal2-title {
            color: #a3aed1 !important;
        }
        ...
        html[data-theme-mode="dark"] .swal2-popup .swal2-title,
        html[data-theme-mode="dark"] .swal2-popup .swal2-html-container {
            color: #a3aed1 !important;
        }
        html[data-theme-mode="dark"] #toast-container > div {
            background-color: #1a1e25 !important;
            color: #a3aed1 !important;
            box-shadow: 0 0.25rem 0.75rem rgba(0, 0, 0, 0.5) !important;
            border: 1px solid rgba(255, 255, 255, 0.05);
